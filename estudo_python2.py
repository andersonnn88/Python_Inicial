#Funções
#As funções são blocos de código reutilizáveis que nos permitem encapsular tarefas específicas e executá-las quando necessário. As funções nos ajudam a organizar nosso código,
#evitar a repetição e fazer com que nossos programas sejam mais modulares e fáceis de manter.
...
print("-----------------Escopo das variáveis (local vs. global)---------------------------------")
